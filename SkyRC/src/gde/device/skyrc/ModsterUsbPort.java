 ...
 */
public class ModsterUsbPort extends DeviceCommPort implements IDeviceCommPort {
	final static String $CLASS_NAME = ModsterUsbPort.class.getName();
	final static Logger	log	= Logger.getLogger($CLASS_NAME);
		
  // The vendor ID SKYRC products are actually not registered.
  protected static final short VENDOR_ID = 0x0483;
  // The product ID SKYRC Q200 
  protected static final short PRODUCT_ID = 0x5750;
  ...
  protected final byte endpointOut;
	...
	public enum QuerySystemSetting {
		CHANNEL_A(new byte[]{0x0f, 0x03, 0x5A, 0x00, 0x5A, (byte) 0xFF, (byte) 0xFF});
		private byte[]	value;
	...
	public enum QueryChannelData {
		CHANNEL_A(new byte[]{0x0F, 0x03, 0x5F, 0x00, 0x5F, (byte) 0xFF, (byte) 0xFF});
		private byte[]	value;
	...
	public enum QueryOperationData {
		CHANNEL_A(new byte[]{0x0F, 0x03, 0x55, 0x00, 0x55, (byte) 0xFF, (byte) 0xFF});
		private byte[]	value;
	...
	public enum QuerySystemInfo {
		CHANNEL_A(new byte[]{0x0f, 0x05, 0x57, 0x00, 0x00, 0x00, 0x57, (byte) 0xFF, (byte) 0xFF});
		private byte[]	value;
