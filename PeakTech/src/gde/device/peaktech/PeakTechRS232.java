 ...
 */
public class PeakTechRS232 extends PeakTech {
	...
	public HashMap<String, String> getMeasurementInfo(byte[] buffer, HashMap<String, String> measurementInfo) {		
		//Byte 9 - 	Status Byte 3 - µ,m,k,M,continuity,diode,%,Z4
		//Byte 10 -	Status Byte 4 - V,A,Ω,hFE,Hz,F,°C,°F
	...
	public String getMode(byte[] buffer) {
		//Byte 7 - 	Status Byte 1 - 0,0,auto,AC,DC,Rel,hold,bpn
		//Byte 8 - 	Status Byte 2 - Z1,Z2,max,min,apo,batt,n,Z3
		String mode = "";
		if ((buffer[7] & 0x20) > 0)
	...
	public int[] convertDataBytes(int[] points, byte[] dataBuffer) {	
		//Byte 0 - 	0x2B for positive, 0x2D for negative values
		//Byte 1..4 - Digits, transferred as ASCII, so 0x30=0, 0x31=1, … one digit each byte
