 ...
 */
public class VarioDialog extends DeviceDialog {
	 ...
	 */
	public VarioDialog(Shell parent, IDevice useDevice) {
		super(parent);
			...
			if (this.dialogShell == null || this.dialogShell.isDisposed()) {
		      ...
		      public void handleEvent(Event event) {
		        ...
		        case SWT.TRAVERSE_ESCAPE:
		        	VarioDialog.this.dialogShell.close();
				...
				this.dialogShell.addHelpListener(new HelpListener() {
					public void helpRequested(HelpEvent evt) {
						...
						VarioDialog.this.application.openHelpDialog("WStechVario", "HelpInfo.html"); //$NON-NLS-1$ //$NON-NLS-2$
					}
				});
...
//				});
				{
					this.tabFolder = new CTabFolder(this.dialogShell, SWT.NONE);
					{
						for (int i = 0; i < this.device.getChannelCount(); i++) {
							this.configurations.add(new VarioTabItem(this.tabFolder, this, (i + 1), this.device));
						}
					}
					{
						...
						this.saveButton.addSelectionListener(new SelectionAdapter() {
							...
							public void widgetSelected(SelectionEvent evt) {
								...
								VarioDialog.this.device.storeDeviceProperties();
								VarioDialog.this.saveButton.setEnabled(false);
							}
						});
					}
					{
					...
					}
					{
						...
						this.closeButton.addSelectionListener(new SelectionAdapter() {
							...
							public void widgetSelected(SelectionEvent evt) {
								...
								VarioDialog.this.dialogShell.dispose();
							}
						});
					}
					...
					this.tabFolder.addSelectionListener(new SelectionAdapter() {
						...
						public void widgetSelected(SelectionEvent evt) {
							...
							int channelNumber = VarioDialog.this.tabFolder.getSelectionIndex();
							if (channelNumber >= 0 && channelNumber <= VarioDialog.this.device.getChannelCount()) { // enable other tabs for future use
								channelNumber += 1;
								...
								if (activeChannel != null) {
									...
									if (activeRecordSet != null && activeChannel.getNumber() != channelNumber) {
										...
										VarioDialog.this.application.updateCurveSelectorTable();
									}
								}
							}
						}
