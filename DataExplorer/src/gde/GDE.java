...
public class GDE {
	...
	public static final String							VERSION														= "Version 3.8.7 beta 1"; // check device update list in settings getServiceUpdateList()																																																			//$NON-NLS-1$
	...
	public final static String							DEVICE_PROPERTIES_XSD_VERSION			= "_V48";																																																										//$NON-NLS-1$
