...
public class GDE {
	...
	public static final String							VERSION														= "Version 3.9.0 beta 13"; // check device update list in settings getServiceUpdateList()																																																			//$NON-NLS-1$
	...
	public final static String							DEVICE_PROPERTIES_XSD_VERSION			= "_V49";																																																										//$NON-NLS-1$
