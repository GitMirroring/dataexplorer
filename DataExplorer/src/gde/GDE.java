...
public class GDE {
	...
	public static final String							VERSION														= "Version 4.0.7 beta 1"; // do not use more than 3 digits, check device update list in settings getServiceUpdateList()																						//$NON-NLS-1$
