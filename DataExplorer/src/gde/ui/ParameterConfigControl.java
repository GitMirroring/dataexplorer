...
public class ParameterConfigControl {
	...
	final Text					text;
	final Color					textColor					= GDE.IS_SYSTEM_DARK_THEME ? SWTResourceManager.getColor(SWT.COLOR_WHITE) : SWTResourceManager.getColor(SWT.COLOR_BLACK);
	...
	public ParameterConfigControl(final Composite parent, final int[] valueArray, final int valueIndex, final String valueFormat, final String parameterName, final int nameWidth,
		...
		}
		{
			...
			this.text.setBackground(GDE.IS_SYSTEM_DARK_THEME ? SWTResourceManager.getColor(isTextValueEditable ? SWT.COLOR_GRAY : SWT.COLOR_WIDGET_DARK_SHADOW) 
	...
	public ParameterConfigControl(final Composite parent, final int[] valueArray, final int valueIndex, final String parameterName, final int nameWidth, final String parameterDescription,
		...
		}
		{
			...
			this.text.setBackground(GDE.IS_SYSTEM_DARK_THEME ? SWTResourceManager.getColor(SWT.COLOR_WIDGET_DARK_SHADOW)
