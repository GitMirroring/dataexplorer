 ...
 */
public class iChargerDX8 extends iChargerUsb {
	 ...
	 */
	public iChargerDX8(String deviceProperties) throws FileNotFoundException, JAXBException {
	 ...
	 * @param deviceConfig
	 */
	public iChargerDX8(DeviceConfiguration deviceConfig) {
		super(deviceConfig);
		this.BATTERIE_TYPES = BatteryTypesX.getValues(); 
	}
