 ...
 */
public class iChargerDX12 extends iChargerUsb {
	 ...
	 */
	public iChargerDX12(String deviceProperties) throws FileNotFoundException, JAXBException {
	 ...
	 * @param deviceConfig
	 */
	public iChargerDX12(DeviceConfiguration deviceConfig) {
		super(deviceConfig);
		this.BATTERIE_TYPES = BatteryTypesX.getValues(); 
	}
