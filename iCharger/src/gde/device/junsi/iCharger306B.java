...
public class iCharger306B extends iCharger {
	 ...
	 */
	public iCharger306B(String deviceProperties) throws FileNotFoundException, JAXBException {
	 ...
	 */
	public iCharger306B(DeviceConfiguration deviceConfig) {
		super(deviceConfig);
	}
