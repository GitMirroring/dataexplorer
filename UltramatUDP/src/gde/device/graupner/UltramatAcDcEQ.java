 ...
 */
public class UltramatAcDcEQ extends Ultramat {
	final static Logger	logger	= Logger.getLogger(UltramatAcDcEQ.class.getName());
	...
	public int getCycleNumber(int outletNum, byte[] dataBuffer) {
		return Integer.parseInt(String.format(DeviceCommPort.FORMAT_2_CHAR, (char) dataBuffer[13], (char) dataBuffer[14]), 16);
	}
}
